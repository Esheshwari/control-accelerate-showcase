...
const DealersSection = () => (
  <section id="dealers" className="section-padding bg-background text-slate-950">
    <div className="section-container">
      <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] items-center">
        <div className="space-y-6">
          <span className="text-sm font-semibold uppercase tracking-[0.35em] text-primary" style={{ fontFamily: "var(--font-heading)" }}>Dealers & Distributors</span>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="card-industrial p-6 bg-slate-950/90 border-white/10">
              <div className="inline-flex h-12 w-12 items-center justify-center rounded-3xl bg-primary/10 text-primary mb-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="card-industrial overflow-hidden rounded-[2rem] bg-slate-950/90 border-white/10">
            <div className="h-40 bg-cover bg-center" style={{ backgroundImage: `url(${heroBg})` }} />
            <div className="p-6">
              <span className="text-sm font-semibold uppercase tracking-[0.35em] text-primary">Distributor Program</span>
          ...
          <div className="card-industrial overflow-hidden rounded-[2rem] bg-slate-950/90 border-white/10">
            ...
            <div className="p-6">
              <span className="text-sm font-semibold uppercase tracking-[0.35em] text-primary">Focused Support</span>
