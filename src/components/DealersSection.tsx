      ...
      <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] items-center">
        <div className="space-y-5">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="card-industrial p-5 bg-black/80 border-red-600/20">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="card-industrial overflow-hidden rounded-[2rem] bg-black/80 border-red-600/20">
            <div className="h-36 bg-cover bg-center" style={{ backgroundImage: `url(${heroBg})` }} />
            <div className="p-6">
          ...
          <div className="card-industrial overflow-hidden rounded-[2rem] bg-black/80 border-red-600/20">
            <div className="h-36 bg-cover bg-center" style={{ backgroundImage: `url(${heroBg2})` }} />
            <div className="p-6">
